...
function showProfileEditor(){
  ...
  const profileEditorBack=sheet.querySelector('.profile-editor-header .brand-back');profileEditorBack.onclick=async()=>{if(profileEditorBack.disabled)return;profileEditorBack.disabled=true;await saveProfileChanges();if(sheet.isConnected)profileEditorBack.disabled=false};
}
