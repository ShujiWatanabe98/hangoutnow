...
function showProfileEditor(){
  ...
  toggleChoices('[data-match-area]');toggleChoices('[data-match-activity]');toggleChoices('[data-match-time]');toggleChoices('[data-match-day]');toggleChoices('[data-match-group]');
