...
test('corporate homepage presents the four methodmore products accurately', async () => {
  ...
  assert.match(coachDemo, /href="\/coachgo-demo\/styles\.css\?v=20260826-2"/);
  ...
  assert.match(coachDemoScript, /continuousDemoDrive\.js\?v=20260826-2/);
  ...
  assert.match(coachDemoScript, /voiceApproach\.js\?v=20260826-2/);
