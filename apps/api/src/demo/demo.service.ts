...
const DEMO_DISCOVERY_TEMPLATES: readonly DemoDiscoveryTemplate[] = [
  ...
  { title: 'スパイスカレーを食べ比べ', category: 'FOOD', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 30, imageAsset: 'hangout-gohan.jpg', organizerEmail: AOI_EMAIL },
  { title: '餃子を囲んで夜ごはん', category: 'DINNER', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-gohan.jpg', organizerEmail: KENTA_EMAIL },
  { title: 'クラフトビールを飲み比べ', category: 'DRINKING', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 60, imageAsset: 'hangout-nomikai.jpg', organizerEmail: KENTA_EMAIL },
  { title: '日本酒を少しずつ楽しむ会', category: 'WINE', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-bar.jpg', organizerEmail: AOI_EMAIL },
  ...
  { title: '古民家カフェでのんびり', category: 'CAFE', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-coffee.jpg', organizerEmail: HOST_EMAIL },
  { title: 'テラスカフェで朝活', category: 'CAFE', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 30, imageAsset: 'hangout-coffee.jpg', organizerEmail: AOI_EMAIL },
  { title: '夜カフェでゆっくり話そう', category: 'CAFE', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 60, imageAsset: 'hangout-coffee.jpg', organizerEmail: KENTA_EMAIL },
  { title: 'ふわふわパンケーキを食べよう', category: 'SWEETS', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 60, imageAsset: 'hangout-sweet.jpg', organizerEmail: HOST_EMAIL },
  { title: 'アフタヌーンティーで交流', category: 'SWEETS', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-sweet.jpg', organizerEmail: AOI_EMAIL },
  { title: '和菓子を少しずつ楽しむ会', category: 'SWEETS', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 30, imageAsset: 'hangout-sweet.jpg', organizerEmail: KENTA_EMAIL },
  { title: '季節のジェラート巡り', category: 'SWEETS', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 60, imageAsset: 'hangout-sweet.jpg', organizerEmail: HOST_EMAIL },
  { title: 'みんなでボウリング', category: 'BOWLING', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 60, imageAsset: 'hangout-dartu.jpg', organizerEmail: AOI_EMAIL },
  { title: 'ゲームセンターで遊ぼう', category: 'ARCADE', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 180, imageAsset: 'hangout-boardgame.jpg', organizerEmail: KENTA_EMAIL },
  { title: '20代・30代のゆる交流会', category: 'SOCIAL', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 30, imageAsset: 'hangout-english.jpg', organizerEmail: HOST_EMAIL },
  { title: 'ひとり参加歓迎のおしゃべり会', category: 'SOCIAL', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 60, imageAsset: 'hangout-english.jpg', organizerEmail: AOI_EMAIL },
  { title: '読書好きの交流会', category: 'SOCIAL', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-english.jpg', organizerEmail: KENTA_EMAIL },
  { title: 'カメラ好きで集まろう', category: 'SOCIAL', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 30, imageAsset: 'hangout-english.jpg', organizerEmail: HOST_EMAIL },
  { title: '地方出身者の交流会', category: 'SOCIAL', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 60, imageAsset: 'hangout-english.jpg', organizerEmail: AOI_EMAIL },
  { title: '公園でゆるくピクニック', category: 'PICNIC', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 60, imageAsset: 'hangout-sanpo.jpg', organizerEmail: KENTA_EMAIL },
  { title: 'サウナでととのう会', category: 'SAUNA', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 180, imageAsset: 'hangout-movie.jpg', organizerEmail: HOST_EMAIL },
  { title: '夜景を眺めながらのんびり', category: 'NIGHT_VIEW', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 180, imageAsset: 'hangout-movie.jpg', organizerEmail: AOI_EMAIL },
  { title: '川沿いで夕涼み', category: 'WATERFRONT', serviceArea: ServiceArea.SHIBUYA, startInMinutes: 60, imageAsset: 'hangout-sanpo.jpg', organizerEmail: KENTA_EMAIL },
  { title: '音楽を聴きながらまったり', category: 'MUSIC', serviceArea: ServiceArea.SHINJUKU, startInMinutes: 30, imageAsset: 'hangout-movie.jpg', organizerEmail: HOST_EMAIL },
];
