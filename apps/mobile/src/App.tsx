  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.content}>
        {screen === 'home' && <HomeScreen user={session.user} hangouts={hangouts} refreshing={refreshing} locationLabel={locationLabel} onLocation={useCurrentLocation} onRefresh={refreshCurrent} onJoin={joinHangout} onFinish={confirmFinishHangout} />}
...
function HomeScreen({ user, hangouts, refreshing, locationLabel, onLocation, onRefresh, onJoin, onFinish }: {user:User;hangouts:Hangout[];refreshing:boolean;locationLabel:string;onLocation:()=>void;onRefresh:()=>void;onJoin:(hangout:Hangout)=>void;onFinish:(hangoutId:string)=>void}) {
