...
type CreateHangoutInput = {title:string;description:string;category:string;startInMinutes:30|60|180;locationName:string;maxParticipants:number;area:AlphaArea};
