  ...
  return <div className="mx-auto max-w-[1400px]">
    ...
    <section className="flex h-[calc(100vh-150px)] min-h-[560px] max-h-[760px] overflow-hidden rounded-[24px] border border-[#dce8e5] bg-white">
      <aside className={`${selectedId ? "hidden md:flex" : "flex"} w-full flex-col border-r border-[#dce8e5] md:w-[340px]`}>
        <div className="border-b border-[#dce8e5] p-3"><label className="flex min-h-11 items-center gap-2 rounded-xl bg-[#f2f6f5] px-3"><Search size={17} className="text-[#71858a]" /><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="利用者を検索" className="min-h-11 min-w-0 flex-1 bg-transparent text-sm outline-none" /></label></div>
