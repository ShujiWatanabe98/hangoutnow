...
export function ScheduleCalendar() {
  ...
  return <div className="mx-auto max-w-[1500px]">
    ...
    <section className="overflow-hidden rounded-[22px] border border-[#d7e4e1] bg-white shadow-[0_12px_35px_rgba(27,61,58,.06)]">
      ...
      {!data ? <div className="p-12 text-center text-sm text-[#71858a]">読み込み中です…</div> : <div role="region" aria-label="予約スケジュール表・左右にスクロールできます" tabIndex={0} className="max-h-[calc(100vh-190px)] overflow-auto overscroll-contain focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#087f71]/30">
