...
await writeFile(
  demoRuntimePath,
  demoRuntime
    .replace('./continuousDemoDrive.js', './continuousDemoDrive.js?v=20260826-7')
    .replace('./divertNaviUnderpasses.js', './divertNaviUnderpasses.js?v=20260826-7')
    .replace('./hazardMap.js', './hazardMap.js?v=20260826-7')
    .replace('./kanagawaPolicePoints.js', './kanagawaPolicePoints.js?v=20260826-7')
    .replace('./mapboxStyle.js', './mapboxStyle.js?v=20260826-7')
    .replace('./naturalSpeech.js', './naturalSpeech.js?v=20260826-7')
    .replace('./smoothUserLocation.js', './smoothUserLocation.js?v=20260826-7')
    .replace('./voiceApproach.js', './voiceApproach.js?v=20260826-7')
    .replace('./voiceHazardReport.js', './voiceHazardReport.js?v=20260826-7'),
  'utf8',
);
...
const publicHtml = sourceHtml
  ...
  .replace('href="/mobile-poc/styles.css"', 'href="/coachgo-demo/styles.css?v=20260826-7"')
  ...
  .replace('src="/mobile-poc/bootstrap.js"', 'src="/coachgo-demo/bootstrap.js?v=20260826-7"');
...
await writeFile(
  ...
  sourceBootstrap.replace('/dist/mobile/demo.js', '/coachgo-demo/dist/mobile/demo.js?v=20260826-7'),
  'utf8',
);
