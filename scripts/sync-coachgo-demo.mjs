...
await writeFile(
  demoRuntimePath,
  demoRuntime
    .replace('./continuousDemoDrive.js', './continuousDemoDrive.js?v=20260901-6')
    .replace('./divertNaviUnderpasses.js', './divertNaviUnderpasses.js?v=20260901-6')
    .replace('./hazardMap.js', './hazardMap.js?v=20260901-6')
    .replace('./kanagawaPolicePoints.js', './kanagawaPolicePoints.js?v=20260901-6')
    .replace('./mapboxStyle.js', './mapboxStyle.js?v=20260901-6')
    .replace('./naturalSpeech.js', './naturalSpeech.js?v=20260901-6')
    .replace('./roadSnapping.js', './roadSnapping.js?v=20260901-6')
    .replace('./smoothUserLocation.js', './smoothUserLocation.js?v=20260901-6')
    .replace('./userReportAggregation.js', './userReportAggregation.js?v=20260901-6')
    .replace('./voiceApproach.js', './voiceApproach.js?v=20260901-6')
    .replace('./voiceHazardReport.js', './voiceHazardReport.js?v=20260901-6')
    .replace('./voiceInputRuntime.js', './voiceInputRuntime.js?v=20260901-6'),
  'utf8',
);
...
const publicHtml = sourceHtml
  ...
  .replace('href="/mobile-poc/styles.css"', 'href="/coachgo-demo/styles.css?v=20260901-6"')
  ...
  .replace('src="/mobile-poc/bootstrap.js"', 'src="/coachgo-demo/bootstrap.js?v=20260901-6"');
...
await writeFile(
  ...
  sourceBootstrap.replace('/dist/mobile/demo.js', '/coachgo-demo/dist/mobile/demo.js?v=20260901-6'),
  'utf8',
);
